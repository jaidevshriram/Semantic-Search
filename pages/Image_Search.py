...
upload = st.file_uploader(label="Find images similar to:", type=["png", "jpg"])

if upload is not None:

    query = Image.open(upload)
    ...
    st.text(f"Retrieved {NUM_RESULTS} results in {round(end-start, 2)} seconds from 25k images")
